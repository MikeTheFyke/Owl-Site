...
/// 45X75 LOGIC
    if (strUser = "45X75" && strUser2 == ".20GA"){
        calculatedWeight = 1.08 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "45X75" && strUser2 == ".40GA"){
        calculatedWeight = 2.16 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "45X75" && strUser2 == ".064GA"){
        calculatedWeight = 3.38 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "45X75" && strUser2 == ".081GA"){
        calculatedWeight = 4.28 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "45X75" && strUser2 == "1.25GA"){
        calculatedWeight = 6.75 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    } 
    if (strUser = "45X75" && strUser2 == "16GA"){
        calculatedWeight = 9.94 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "45X75" && strUser2 == "1/2PLY"){
        calculatedWeight = 4.69 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "45X75" && strUser2 == "3/4MDO"){
        calculatedWeight = 8.44 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "45X75" && strUser2 == ".090POLY"){
        calculatedWeight = 1.88 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    } 
/// 45X90 LOGIC
    if (strUser = "45X90" && strUser2 == ".20GA"){
        calculatedWeight = 1.3 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "45X90" && strUser2 == ".40GA"){
        calculatedWeight = 2.59 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "45X90" && strUser2 == ".064GA"){
        calculatedWeight = 4.05 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "45X90" && strUser2 == ".081GA"){
        calculatedWeight = 5.14 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "45X90" && strUser2 == "1.25GA"){
        calculatedWeight = 8.1 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    } 
    if (strUser = "45X90" && strUser2 == "16GA"){
        calculatedWeight = 11.93 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "45X90" && strUser2 == "1/2PLY"){
        calculatedWeight = 5.63 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "45X90" && strUser2 == "3/4MDO"){
        calculatedWeight = 10.13 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "45X90" && strUser2 == ".090POLY"){
        calculatedWeight = 2.25 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    } 
/// 60X60 LOGIC
    if (strUser = "60X60" && strUser2 == ".20GA"){
        calculatedWeight = 1.15 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X60" && strUser2 == ".40GA"){
        calculatedWeight = 2.3 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X60" && strUser2 == ".064GA"){
        calculatedWeight = 3.6 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X60" && strUser2 == ".081GA"){
        calculatedWeight = 5.64 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X60" && strUser2 == "1.25GA"){
        calculatedWeight = 7.2 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    } 
    if (strUser = "60X60" && strUser2 == "16GA"){
        calculatedWeight = 10.6 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X60" && strUser2 == "1/2PLY"){
        calculatedWeight = 5 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X60" && strUser2 == "3/4MDO"){
        calculatedWeight = 9 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X60" && strUser2 == ".090POLY"){
        calculatedWeight = 2 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    } 
/// 60X75 LOGIC
    if (strUser = "60X75" && strUser2 == ".20GA"){
        calculatedWeight = 1.44 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X75" && strUser2 == ".40GA"){
        calculatedWeight = 2.88 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X75" && strUser2 == ".064GA"){
        calculatedWeight = 4.5 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X75" && strUser2 == ".081GA"){
        calculatedWeight = 5.7 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X75" && strUser2 == "1.25GA"){
        calculatedWeight = 9 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    } 
    if (strUser = "60X75" && strUser2 == "16GA"){
        calculatedWeight = 13.25 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X75" && strUser2 == "1/2PLY"){
        calculatedWeight = 6.25 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X75" && strUser2 == "3/4MDO"){
        calculatedWeight = 11.25 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X75" && strUser2 == ".090POLY"){
        calculatedWeight = 2.5 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    } 
/// 60X90 LOGIC
    if (strUser = "60X90" && strUser2 == ".20GA"){
        calculatedWeight = 1.73 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X90" && strUser2 == ".40GA"){
        calculatedWeight = 3.46 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X90" && strUser2 == ".064GA"){
        calculatedWeight = 5.41 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X90" && strUser2 == ".081GA"){
        calculatedWeight = 6.85 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X90" && strUser2 == "1.25GA"){
        calculatedWeight = 10.8 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    } 
    if (strUser = "60X90" && strUser2 == "16GA"){
        calculatedWeight = 15.9 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X90" && strUser2 == "1/2PLY"){
        calculatedWeight = 7.5 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X90" && strUser2 == "3/4MDO"){
        calculatedWeight = 13.5 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "60X90" && strUser2 == ".090POLY"){
        calculatedWeight = 3 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    } 
}
/// 75X75 LOGIC
    if (strUser = "75X75" && strUser2 == ".20GA"){
        calculatedWeight = 1.9 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "75X75" && strUser2 == ".40GA"){
        calculatedWeight = 3.6 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "75X75" && strUser2 == ".064GA"){
        calculatedWeight = 5.63 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "75X75" && strUser2 == ".081GA"){
        calculatedWeight = 8.7 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "75X75" && strUser2 == "1.25GA"){
        calculatedWeight = 11.25 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    } 
    if (strUser = "75X75" && strUser2 == "16GA"){
        calculatedWeight = 16.56 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "75X75" && strUser2 == "1/2PLY"){
        calculatedWeight = 7.81 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "75X75" && strUser2 == "3/4MDO"){
        calculatedWeight = 14.06 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "75X75" && strUser2 == ".090POLY"){
        calculatedWeight = 3.13 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    } 
/// 75X90 LOGIC
    if (strUser = "75X90" && strUser2 == ".20GA"){
        calculatedWeight = 2.16 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "75X90" && strUser2 == ".40GA"){
        calculatedWeight = 4.32 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "75X90" && strUser2 == ".064GA"){
        calculatedWeight = 6.3 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "75X90" && strUser2 == ".081GA"){
        calculatedWeight = 8.93 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "75X90" && strUser2 == "1.25GA"){
        calculatedWeight = 13.5 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    } 
    if (strUser = "75X90" && strUser2 == "16GA"){
        calculatedWeight = 19.04 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "75X90" && strUser2 == "1/2PLY"){
        calculatedWeight = 9.38 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "75X90" && strUser2 == "3/4MDO"){
        calculatedWeight = 16.88 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "75X90" && strUser2 == ".090POLY"){
        calculatedWeight = 3.75 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    } 
/// 90X90 LOGIC
    if (strUser = "90X90" && strUser2 == ".20GA"){
        calculatedWeight = 2.59 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "90X90" && strUser2 == ".40GA"){
        calculatedWeight = 5.18 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "90X90" && strUser2 == ".064GA"){
        calculatedWeight = 8.11 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "90X90" && strUser2 == ".081GA"){
        calculatedWeight = 10.37 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "90X90" && strUser2 == "1.25GA"){
        calculatedWeight = 16.2 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    } 
    if (strUser = "90X90" && strUser2 == "16GA"){
        calculatedWeight = 23.35 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "90X90" && strUser2 == "1/2PLY"){
        calculatedWeight = 11.25 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "90X90" && strUser2 == "3/4MDO"){
        calculatedWeight = 20.25 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "90X90" && strUser2 == ".090POLY"){
        calculatedWeight = 4.5 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    } 
/// 90X120 LOGIC
    if (strUser = "90X120" && strUser2 == ".20GA"){
        calculatedWeight = 3.46 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "90X120" && strUser2 == ".40GA"){
        calculatedWeight = 6.91 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "90X120" && strUser2 == ".064GA"){
        calculatedWeight = 10.31 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "90X120" && strUser2 == ".081GA"){
        calculatedWeight = 13.63 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "90X120" && strUser2 == "1.25GA"){
        calculatedWeight = 21.5 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    } 
    if (strUser = "90X120" && strUser2 == "16GA"){
        calculatedWeight = 31.8 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "90X120" && strUser2 == "1/2PLY"){
        calculatedWeight = 15 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "90X120" && strUser2 == "3/4MDO"){
        calculatedWeight = 27 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    }
    if (strUser = "90X120" && strUser2 == ".090POLY"){
        calculatedWeight = 6 * numberOfSigns;
        document.getElementById("totalWeight").innerHTML = calculatedWeight;
    } 
/// 120X120 LOGIC
